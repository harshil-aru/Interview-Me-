...
class EditInterview extends Component {
  ...
  constructor(props) {
    super(props);
     let earlierDate = parseISO(props.location.state.pdate);
     let earlierstartTime = props.location.state.pstarttime;
     let earlierendTime = props.location.state.pendtime;
    ...
    this.state = {
      ...
      participants: [],
      checkedItems: props.location.state.checkedItems,
      duration: props.location.state.duration,
      description: props.location.state.description,
      earlierParticipant: props.location.state.pid,
      error: false,
      errorMsg: ""
    }
  ...
  handleFormSubmit(event) {
    ...
    const interviewInfo = {
      id: this.state.earlierParticipant
    }
